...
2. Implement Add Contact Function: Write a function named addContact that takes a Contact object and adds it to an array of Contact objects.
   Ensure that each contact has a unique id.
3. Implement Remove Contact Function:
...
5. Optional: Enhance Search Functionality:
